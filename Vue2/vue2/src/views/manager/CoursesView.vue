    ...
    <div class="">
        ...
        <el-dialog title="收货地址" :visible.sync="fromVisible" width="30%">
            <el-form :model="form" label-width="80px" style="padding-right: 20px" :rules="rules" ref="formRef">
                ...
                <el-input v-model="form.course_code" placeholder="课程代码"></el-input>
                </el-form-item>
                <el-form-item label="课程名称" prop="course_name">
                <el-input v-model="form.course_name" placeholder="课程名称"></el-input>
                </el-form-item>
                <el-form-item label="学分" prop="credits">
                <el-input v-model="form.credits" placeholder="学分"></el-input>
                </el-form-item>
                <el-form-item label="课程简介" prop="description">
                <el-input v-model="form.description" placeholder="课程简介"></el-input>
                </el-form-item>
                <el-form-item label="学期" prop="semester">
                <el-input type="textarea" v-model="form.semester" placeholder="学期"></el-input>
                </el-form-item>
            </el-form>
    ...
    methods:{
        ...
        delBatch() {
            ...
            this.$confirm('您确认批量删除这些数据吗？', '确认删除', {type: "warning"}).then(response => {
                this.$request.delete('/courses/delete/batch', { data: this.ids }).then(res => {
        ...
        del(id) {
            ...
            this.$confirm('您确认删除吗？', '确认删除', {type: "warning"}).then(response => {
                this.$request.delete('/courses/delete/' + id).then(res => {
                if (res.code === '200') {   // 表示操作成功
                    this.$message.success('操作成功')
                    this.load(1)
                } else {
        ...
        save() {   // 保存按钮触发的逻辑  它会触发新增或者更新
            this.$refs.formRef.validate((valid) => {
                if (valid) {
                this.$request({
                    url: this.form.id ? '/courses/update': '/courses/add',
